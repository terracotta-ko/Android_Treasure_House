...
public class LayoutManager {
    ...
    private void reset() {
        ...
        sm(LayoutID.IMAGE_WIDTH, 100);
        sm(LayoutID.IMAGE_HEIGHT, 100);

        sm(LayoutID.TEXT_VIEW_LEFT_MARGIN, 20);
    }
    ...
    private void updateLayout() {
        ...
        as(LayoutID.IMAGE_WIDTH);
        as(LayoutID.IMAGE_HEIGHT);

        as(LayoutID.TEXT_VIEW_LEFT_MARGIN);
    }
